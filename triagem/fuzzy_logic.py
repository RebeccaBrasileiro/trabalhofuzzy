...
def calcular_triagem(temp_val, spo2_val, dor_val, fc_val):
    ...
    regras = [
        ...
        ctrl.Rule(
            temperatura["alta"] & (frequencia["taquicardia"] | dor["severa"]),
            prioridade["vermelho"],
        ),
        ctrl.Rule(
        ...
        ctrl.Rule(
            temperatura["febre"] & frequencia["taquicardia"], prioridade["amarelo"]
        ),
        ctrl.Rule(
            frequencia["bradicardia"] & oxigenio["normal"], prioridade["amarelo"]
        ),
        ...
        ctrl.Rule(
            temperatura["febre"] & frequencia["normal"] & oxigenio["normal"],
            prioridade["verde"],
        ),
        ctrl.Rule(
            dor["moderada"] & frequencia["normal"] & temperatura["normal"],
            prioridade["verde"],
        ),
        ctrl.Rule(
            temperatura["normal"]
            & frequencia["taquicardia"]
            & oxigenio["normal"]
            & dor["leve"],
            prioridade["verde"],
        ),
    ...
    try:
        simulador.compute()
        return (
            float(simulador.output["prioridade"]),
            simulador,
            temperatura,
            oxigenio,
            dor,
        ...
        return 45.0, None, temperatura, oxigenio, dor, frequencia, prioridade
